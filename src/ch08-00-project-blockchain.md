...
이 장에서는 지금까지 배운 모든 것을 종합하여 실제로 동작하는 블록체인을 Rust로 구현합니다.
...
*이 가이드북을 완료했습니다. Rust의 기초부터 블록체인 구현까지 커버했습니다. 다음 단계로 Solana Anchor 프로그래밍이나 Ethereum 스마트 컨트랙트 개발을 시작할 준비가 되었습니다.*
